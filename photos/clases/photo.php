<?php
class Photo extends Obj
{
    protected static $table = "photos";
    protected static $table_fields = array('title','author', 'caption', 'filename', 'type', 'size');
    public $id;
    public $title;
    public $author;
    public $caption;
    ...
    public $upload_errors_array = array(
        ...
        UPLOAD_ERR_PARTIAL => "The uploaded file was only partiallly uploaded.",
    ...
    public function set_file($file)
    {
        if (empty($file) || !$file || !is_array($file)) {
            $this->errors[] = "There was no file uloaded here";
            return false;
        } elseif ($file['error'] != 0) {
            ...
            $dt = new DateTime();
            $dt_str = $dt->format('Y_m_d_H_i_s');
            $this->filename = $dt_str . basename($file['name']);
